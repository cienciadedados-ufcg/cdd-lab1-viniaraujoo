...
De acordo com gráfico acima observamos que a série The Blaclist possui uma variação de pontos atribuídos como podemos observar que na primeira temporada a pontuação atribuída se concentram em algo entre 8,0 e 9,0, porém, nas temporadas subsequentes, observamos que os que pontos vão diminuindo e na quarta temporada eles se dividem na metade ficando uma parte entre 7,0 e 8,0. Desse modo verificamos que ao longo das temporadas ocorreu uma mudança considerável.
