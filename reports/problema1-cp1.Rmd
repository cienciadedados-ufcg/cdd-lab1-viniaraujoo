...
De acordo com gráfico acima observamos que a série The Blaclist possui uma variação de pontos atribuídos como podemos observar que na primeira temporada a pontuação atribuída se concentram em algo entre 8,0 e 9,0 e ao decorrer das próximas temporadas observamos que os que pontos que significa os voto atribuído vão diminuindo e na quarta temporada os pontos se dividem na metade ficando uma parte entre 7,0 e 8,0 desse modo verificamos que ao longo das temporadas ocorreu uma mudança considerável.
