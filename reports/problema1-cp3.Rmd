...
Para melhorar nossa qualificação separa um conjunto de dados contendo os 10 episódios mais bem avaliados.
```{r message=FALSE}
  top_10_avaliados <- dados_escolhidos %>% arrange(-user_votes) %>% top_n(10)
